  ...
  return (
    ...
    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
      ...
      <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
        <div className="lg:pr-4">
          <div className="max-w-xl text-base leading-7 text-base-content lg:max-w-lg">
            <p>
            ...
            <ul role="list" className="mt-8 space-y-8 text-base-content">
              ...
              <li className="flex gap-x-3">
                <span>
                  <strong className="font-semibold text-primary">SSL certificates.</strong> Anim aute id magna aliqua
                  ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo.
                </span>
              </li>
              <li className="flex gap-x-3">
                <span>
                  <strong className="font-semibold text-primary">Database backups.</strong> Ac tincidunt sapien
...
export default StickyProductContentBlock